  ...
  return (
    <div className="fixed left-0 right-0 bottom-0 md:hidden grid grid-cols-2 gap-2 p-3 bg-white border-t border-gray-200 shadow-lg z-50">
      <a 
        ...
        className="text-center font-bold py-3 px-3 rounded-xl bg-primary text-white transition-all duration-200 active:scale-95 hover:bg-primary/90"
      ...
      <a 
        ...
        className="text-center font-bold py-3 px-3 rounded-xl bg-accent text-white transition-all duration-200 active:scale-95 hover:bg-accent/90"
