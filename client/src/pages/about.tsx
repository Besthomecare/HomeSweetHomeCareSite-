      ...
      <section className="bg-secondary py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-8">About Us</h1>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-6 text-center">Our Values</h2>
            
            <div className="grid md:grid-cols-2 gap-8 mt-10">
              <div className="bg-secondary p-6 rounded-lg">
                <h3 className="text-xl md:text-2xl font-semibold text-primary mb-3">Compassion</h3>
              ...
              <div className="bg-secondary p-6 rounded-lg">
                <h3 className="text-xl md:text-2xl font-semibold text-primary mb-3">Dignity</h3>
                <p className="text-lg leading-relaxed">
              ...
              <div className="bg-secondary p-6 rounded-lg">
                <h3 className="text-xl md:text-2xl font-semibold text-primary mb-3">Excellence</h3>
                <p className="text-lg leading-relaxed">
              ...
              <div className="bg-secondary p-6 rounded-lg">
                <h3 className="text-xl md:text-2xl font-semibold text-primary mb-3">Reliability</h3>
                <p className="text-lg leading-relaxed">
